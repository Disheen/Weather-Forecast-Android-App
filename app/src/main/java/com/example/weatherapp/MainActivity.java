...
public class MainActivity extends AppCompatActivity {
    ...
    private void getCoordinates(Intent intent) {
        ...
        String url="https://ipinfo.io/?token=9d3e16965e4377";
        StringRequest stringRequest=new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    String loc=main_response.getString("loc");
                    Log.i("Coord",loc);
                    String city=main_response.getString("city");
                    String region=main_response.getString("region");
                    String addr=city+","+region;
                                getResults(loc,intent,addr);
                } catch (JSONException e) {
                    e.printStackTrace();
                }

                Log.d("GeoLOc",response);
            }
                ...
                StringRequest stringRequest=new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            arrayAdapter = new ArrayAdapter<String>(MainActivity.this, R.layout.row,suggestions);
                            listView.setAdapter(arrayAdapter);
                            arrayAdapter.getFilter().filter(newText);
                            Log.i("SI","dsf");
                            ListView lv = (ListView) findViewById(R.id.list_view) ;
                            Log.i("LV", String.valueOf(lv));
                            if(lv!=null) {
...
//                }
    ...
    public void selectItem(SearchView searchView) {
